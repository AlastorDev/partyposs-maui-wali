const CACHE='partyposs-v3-walking';
const FILES=['./','./index.html','./style.css','./adventure.css','./game.js','./core.js','./world.js','./adventure.js','./art.js','./walking.js','./geo.js','./icons.js','./walking.css','./vendor/leaflet/leaflet.js','./vendor/leaflet/leaflet.css','./manifest.webmanifest','./assets/meadow.webp','./assets/partyposs.webp','./assets/partyposs-attack.webp','./assets/camp-items.webp','./assets/effects.webp','./assets/icon.png','./assets/critters-a.webp','./assets/critters-b.webp','./assets/trail-map.webp'];
